"""Repro deposu kurucusu: git'ten temiz export -> calibration-law-fer/ (+ zip).
...
Çıktı:     <dest>/calibration-law-fer/  +  calibration-law-fer_<commit>.zip
...
NAME = "calibration-law-fer"   # ad önerisi — Fatih onaylayacak
...
DENY = ["**/_greyscale/*", "paper/*",
        ...
        "diagnostics/export_to_drive.py", "diagnostics/status_heartbeat.py",
