...
**Ham koşu tablosu:** [`runs.csv`](runs.csv) (89 koşu, `diagnostics/build_runs_ledger.py` ile
koşuların kendi `run_args.json` / `metrics_best.json` dosyalarından türetilir — elle yazılmaz).
...
Belirtilen ± değerleri **popülasyon sd**'sidir (n=3), standart hata değildir.
