...
| | |
|---|---|
| denetlenen üretici | 63 |
| Katman A (koş + bayt karşılaştır) | 54 |
...
| koşu başında zaten değişmiş dosya | 15 |

> **Bu koşudaki 0 nasıl okunmalı.** Katman A yalnız kendi koşusundan önce TEMİZ olan dosyaları yan çıktı sayar; kapı kullanıcının halihazırdaki değişikliğine dokunmaz. Koşu başında ağaçta **15** değişmiş dosya vardı, dolayısıyla bu 0 "hiç yan çıktı yok" değil, "atfedilebilir yan çıktı yok" demektir. Temiz ağaçta koşulan kapı bu belirsizliği taşımaz.

## Ölçülen süreler (Katman A adayları)

n=54 · min 0.1 s · medyan 0.2 s · maks 45.2 s · toplam 204 s · eşik **90 s**
...
| `diagnostics/bootstrap_cis.py` | 38.2 |
| `diagnostics/headroom_grid_audit.py` | 27.6 |
| `diagnostics/teacher_ece_grid.py` | 8.9 |
