...
| | |
|---|---|
| denetlenen üretici | 60 |
| Katman A (koş + bayt karşılaştır) | 52 |
...
|---|---|---|---|---|
| `diagnostics/a12_realsignal_verdict.py` | **A** | ölçülen süre 0.2 s | `diagnostics/a12_realsignal_gate/a12_verdict.md`<br>`diagnostics/a12_realsignal_gate/a12_verdict.json` | geçti |
...
| `diagnostics/asymmetry_estimand.py` | **A** | ölçülen süre 5.5 s | `diagnostics/paper_tables/asymmetry_estimand.md`<br>`diagnostics/paper_tables/asymmetry_estimand.json` | geçti |
...
| `diagnostics/b015_verdict.py` | **A** | ölçülen süre 0.0 s | `diagnostics/selection_audit/b015_verdict.json` | geçti |
| `diagnostics/bootstrap_cis.py` | **A** | ölçülen süre 33.2 s | `diagnostics/paper_tables/bootstrap_cis.md`<br>`diagnostics/paper_tables/bootstrap_cis.json` | geçti |
...
| `diagnostics/dose_response_per_seed.py` | **A** | ölçülen süre 5.5 s | `diagnostics/paper_tables/dose_response_per_seed.md`<br>`diagnostics/paper_tables/dose_response_per_seed.json` | geçti |
...
| `diagnostics/ferplus_abstention_entropy.py` | **A** | ölçülen süre 1.5 s | `diagnostics/paper_tables/ferplus_abstention_entropy.md`<br>`diagnostics/paper_tables/ferplus_abstention_entropy.json` | geçti |
| `diagnostics/ferplus_human_vote_jsd.py` | **A** | ölçülen süre 4.2 s | `diagnostics/ferplus_jsd/ferplus_jsd.json` | geçti |
| `diagnostics/ferplus_student_jsd.py` | **A** | ölçülen süre 3.9 s | `diagnostics/ferplus_jsd/ferplus_student_jsd.json`<br>`diagnostics/ferplus_jsd/ferplus_student_jsd_rows.json` | geçti |
...
| `diagnostics/graphical_abstract.py` | **A** | ölçülen süre 0.7 s | `paper/figures/graphical_abstract.png` | geçti |
| `diagnostics/headroom_grid_audit.py` | **A** | ölçülen süre 24.6 s | `diagnostics/paper_tables/headroom_grid_audit.md`<br>`diagnostics/paper_tables/headroom_grid_audit.json` | geçti |
...
| `diagnostics/holm_family.py` | **A** | ölçülen süre 0.0 s | `diagnostics/paper_tables/holm_family.md`<br>`diagnostics/paper_tables/holm_family.json` | geçti |
...
| `diagnostics/jsd_collapse_audit.py` | **A** | ölçülen süre 4.1 s | `diagnostics/paper_tables/jsd_collapse_audit.md`<br>`diagnostics/paper_tables/jsd_collapse_audit.json` | geçti |
| `diagnostics/jsd_sensitivity.py` | **A** | ölçülen süre 4.9 s | `diagnostics/paper_tables/jsd_sensitivity.md`<br>`diagnostics/paper_tables/jsd_sensitivity.json` | geçti |
| `diagnostics/mechanism_diagnostic_figure.py` | **A** | ölçülen süre 0.6 s | `diagnostics/paper_tables/mechanism_diagnostic.json`<br>`diagnostics/paper_tables/mechanism_diagnostic.png` | geçti |
...
| `diagnostics/mechanism_specs.py` | **A** | ölçülen süre 0.0 s | `diagnostics/paper_tables/mechanism_specs.md`<br>`diagnostics/paper_tables/mechanism_specs.json` | geçti |
| `diagnostics/monotonicity_test.py` | **A** | ölçülen süre 0.0 s | `diagnostics/paper_tables/monotonicity_test.md`<br>`diagnostics/paper_tables/monotonicity_test.json` | geçti |
...
| `diagnostics/p6_verdict.py` | **A** | ölçülen süre 4.4 s | `diagnostics/paper_tables/p6_collapse_test.md`<br>`diagnostics/paper_tables/p6_collapse_test.json` | geçti |
| `diagnostics/paper_tables.py` | **A** | ölçülen süre 4.1 s | `diagnostics/paper_tables/RESULTS_TABLES.md`<br>`diagnostics/paper_tables/RESULTS_TABLES.json` | geçti |
| `diagnostics/perclass_crossing_table.py` | **A** | ölçülen süre 0.0 s | `diagnostics/paper_tables/perclass_crossing.md`<br>`diagnostics/paper_tables/perclass_crossing.json` | geçti |
| `diagnostics/r3w1_joint_optimum.py` | **A** | ölçülen süre 4.2 s | `diagnostics/paper_tables/r3w1_joint_optimum.md`<br>`diagnostics/paper_tables/r3w1_joint_optimum.json` | geçti |
...
| `diagnostics/robustness_metrics.py` | **A** | ölçülen süre 4.7 s | `diagnostics/paper_tables/robustness_metrics.md`<br>`diagnostics/paper_tables/robustness_metrics.json` | geçti |
...
| `diagnostics/student_ts_baseline.py` | **A** | ölçülen süre 4.2 s | `diagnostics/paper_tables/student_ts_baseline.md`<br>`diagnostics/paper_tables/student_ts_baseline.json` | geçti |
...
| `diagnostics/teacher_ece_grid.py` | **A** | ölçülen süre 7.5 s | `diagnostics/teacher_ece_grid/teacher_ece_grid.json` | geçti |
| `diagnostics/tstar_provenance.py` | **A** | ölçülen süre 0.0 s | `diagnostics/paper_tables/tstar_provenance.md`<br>`diagnostics/paper_tables/tstar_provenance.json` | geçti |
| `diagnostics/tstar_sensitivity.py` | **A** | ölçülen süre 6.1 s | `diagnostics/paper_tables/tstar_sensitivity.md`<br>`diagnostics/paper_tables/tstar_sensitivity.json` | geçti |
| `diagnostics/tstar_stability.py` | **A** | ölçülen süre 4.8 s | `diagnostics/paper_tables/tstar_stability.md`<br>`diagnostics/paper_tables/tstar_stability.json` | geçti |
| `diagnostics/two_dataset_overlay.py` | **A** | ölçülen süre 5.0 s | `diagnostics/p1_dose_response/two_dataset_overlay.json` | geçti |
