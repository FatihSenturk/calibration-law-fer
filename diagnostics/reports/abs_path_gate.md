...
Metin dışı (ikili) dosya atlandı: 67. Uzantı listesi betikte yazılı — kapsam daralması sessiz olmasın. **Okunamayan dosya: 0** (sıfır olmak zorunda; değilse kapı düşer).
