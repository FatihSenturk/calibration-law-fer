...
| K | n | raw a2 (max−mean) | §4 value | OLS drift (over the window) | **detrended a2** |
|---|---|---|---|---|---|
| 50 | 131 | +0.645 ± 0.203 | +0.642 | +0.146 ± 0.515 pp | **+0.640 ± 0.218** |
| 100 | 131 | +0.764 ± 0.259 | +0.768 | -0.015 ± 0.435 pp | **+0.728 ± 0.238** |
